public abstract class Vegetable : GameObject, IVegetable 
{
    ...
    public int PowerBonus
    {
        ...
        protected set { this.powerBonus = value; }
    }

    public int StaminaBonus
    {
        get { return this.staminaBonus; }
        protected set { this.staminaBonus = value; }
    }

    public int TimeToGrow
    {
        get { return this.timeToGrow; }
        protected set { this.timeToGrow = value; }
    }
}
